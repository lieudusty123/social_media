...
const Post = (props) => {
  ...
  function sendNewComment(e) {
    ...
    if (data.userName && commentContent.length > 0) {
      ...
      let localArr = (
        <li className="card_comment" key={uuidv4()}>
          <div>
            <div className="card_comment_name">{data.userName}</div>
  ...
  useEffect(() => {
    ...
    let localArr = props.data.engagement.comments.map((element) => (
      <li className="card_comment" key={uuidv4()}>
        <div>
          <div className="card_comment_name">{element.userName}</div>
    ...
    <div className="card">
      <div className="card_header">
        <div className="card_header_content">
          ...
          />
          <div className="card_header_name">{props.data.userName.name}</div>
        </div>
      </div>
      <div className="card_body">
        ...
        <div className="card_body_buttons">
          <button className="card_body_like" onClick={submitLike}>
            <img
              alt="like button"
              ref={likeButton}
              className={
          ...
          <div
            onClick={(e) => {
              ...
              if (isFullTitle) {
                ...
                e.target.parentElement.style.height = "42px";
              } else {
      ...
      <div className="card_footer">
        <ul className="card_comment_list" ref={commentList}>
          {mappedComments}
        </ul>
